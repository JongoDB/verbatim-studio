  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-3 left-3 z-40 md:hidden min-w-touch min-h-touch flex items-center justify-center rounded-lg bg-card border border-border shadow-sm"
