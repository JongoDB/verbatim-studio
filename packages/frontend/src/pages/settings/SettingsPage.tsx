      ...
      {txSettings && (
        <div className="mt-6 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
          ...
          <div className="px-5 py-4 space-y-5">
            ...
            {/* External WhisperX Service (Enterprise Only) */}
            {txSettings.is_enterprise && (
              <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                ...
                {txSettings.external_url && !externalUrlInput && (
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder={txSettings.external_url ? 'Enter new URL to replace...' : 'https://whisperx.example.com/api'}
                      className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 py-2 px-3 text-sm text-gray-900 dark:text-gray-100 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 font-mono"
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-xs text-gray-500 dark:text-gray-400 mb-1">
                      API Key {txSettings.external_api_key_set && <span className="text-green-600 dark:text-green-400">(configured: {txSettings.external_api_key_masked})</span>}
                    </label>
                    <div className="relative">
                      <input
                        ...
                        placeholder={txSettings.external_api_key_set ? 'Enter new key to replace...' : 'sk-...'}
                        className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 py-2 px-3 pr-10 text-sm text-gray-900 dark:text-gray-100 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 font-mono"
                      />
                      <button
                        type="button"
                        onClick={() => setShowExternalApiKey(!showExternalApiKey)}
                        className="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
                      >
                        {showExternalApiKey ? (
                          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                  ...
                  <button
                    ...
                    disabled={!externalUrlInput.trim() || txSaving}
                  ...
                  >
                    {txSettings.external_url ? 'Update Connection' : 'Connect'}
                  </button>
                </div>
              </div>
            )}
